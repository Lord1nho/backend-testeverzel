...
Esta pasta concentra os artefatos mais úteis para implementar regras de negócio, banco de dados e integrações.
...
- Controle de assentos e reservas.
- Pagamento simulado ou sandbox.
- Emissão de ingresso com QR Code seguro.
